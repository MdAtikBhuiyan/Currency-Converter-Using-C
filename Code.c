...
//_______________________________
        ...
        setcolor(36);
        gotoxy(34,7);
        printf("SELECT A CURRENCY FROM WHICH YOU WANT TO CONVERT");
        setcolor(39);
        gotoxy(25,12);
        printf("1.  Bangladeshi Taka     (BDT)     6 . Singapore Dollar       (SGD)");
        gotoxy(25,13);
        printf("2.  India Rupee          (INR)     7 . Malaysian Ringgit      (MYR)");
        gotoxy(25,14);
        printf("3.  US. Dollar           (USD)     8 . Japanese Yen           (JPY)");
        gotoxy(25,15);
        printf("4.  British Pound        (GBP)     9 . Chinese Yuan Renminbi  (CNY)");
        gotoxy(25,16);
        printf("5.  Australian Dollar    (AUD)     10. New Zealand Dollar     (NZD)");
...
//_______________________________
    ...
    setcolor(36);
    gotoxy(34,7);
    printf("SELECT A CURRENCY  IN  WHICH YOU WANT TO CONVERT");
    setcolor(39);
    gotoxy(25,12);
    printf("1.  India Rupee          (INR)     6 . Malaysian Ringgit      (MYR)");
    gotoxy(25,13);
    printf("2.  US. Dollar           (USD)     7 . Japanese Yen           (JPY)");
    gotoxy(25,14);
    printf("3.  British Pound        (GBP)     8 . Chinese Yuan Renminbi  (CNY)");
    gotoxy(25,15);
    printf("4.  Australian Dollar    (AUD)     9 . New Zealand Dollar     (NZD)");
    gotoxy(25,16);
    printf("5.  Singapore Dollar     (SGD)");
...
//_______________________________
    ...
    setcolor(39);
    gotoxy(25,12);
    printf("1.  Bangladeshi Taka     (BDT)     6 . Malaysian Ringgit      (MYR)");
    gotoxy(25,13);
    printf("2.  US. Dollar           (USD)     7 . Japanese Yen           (JPY)");
    gotoxy(25,14);
    printf("3.  British Pound        (GBP)     8 . Chinese Yuan Renminbi  (CNY)");
...
//_______________________________
    ...
    printf("1.  Bangladeshi Taka     (BDT)     6 . Malaysian Ringgit      (MYR)");
    gotoxy(25,13);
    printf("2.  India Rupee          (INR)     7 . Japanese Yen           (JPY)");
    gotoxy(25,14);
    printf("3.  British Pound        (GBP)     8 . Chinese Yuan Renminbi  (CNY)");
    gotoxy(25,15);
    printf("4.  Australian Dollar    (AUD)     9 . New Zealand Dollar     (NZD)");
...
//_______________________________
    ...
    printf("2.  India Rupee          (INR)     7 . Japanese Yen           (JPY)");
    gotoxy(25,14);
    printf("3.  US. Dollar           (USD)     8 . Chinese Yuan Renminbi  (CNY)");
    gotoxy(25,15);
    printf("4.  Australian Dollar    (AUD)     9 . New Zealand Dollar     (NZD)");
    gotoxy(25,16);
    printf("5.  Singapore Dollar     (SGD)");
...
//_______________________________
    ...
    printf("3.  US. Dollar           (USD)     8 . Chinese Yuan Renminbi  (CNY)");
    gotoxy(25,15);
    printf("4.  British Pound        (GBP)     9 . New Zealand Dollar     (NZD)");
    gotoxy(25,16);
    printf("5.  Singapore Dollar     (SGD)");
